 ...
 * @author User
 * 
 * Esta clase es una interfaz en la que se hará la validacion de los uusarios
 */
public class Usuarios extends javax.swing.JFrame {
    ...
    private void buttonAction1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAction1ActionPerformed
      ...
      // String mens = l.validarUsuario(txtUsuario.getText().trim(), txtPassword.getText());
        
       String mens;  
       mens = l.validarUsuario(txtUsuario.getText().trim(), txtPassword.getText().trim());
